        ...
        affine.for %arg2 = 0 to 3 {
          ...
          affine.parallel (%arg3) = (0) to (5) {
            affine.for %arg4 = 0 to 5 {
              ...
              %23 = "equeue.read"(%19) {bank = 0 : i64, size = dense<1> : tensor<1xi64>} : (memref<1x3x3x1xf32, #map6>) -> f32
              %24 = "equeue.read"(%17) {bank = 0 : i64, size = dense<1> : tensor<1xi64>} : (memref<5x5x1x1xf32>) -> f32
              %25 = "equeue.read"(%18) {bank = 0 : i64, size = dense<1> : tensor<1xi64>} : (memref<1x3x3x1xf32>) -> f32
              %26 = mulf %23, %24 : f32
              %27 = addf %25, %26 : f32
              "equeue.write"(%27, %18) {bank = 0 : i64} : (f32, memref<1x3x3x1xf32>) -> ()
            }
          }
        }
      }
