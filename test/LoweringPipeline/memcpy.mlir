...
module {
  func @graph(%arg0: memref<7x7xf32>, %arg1: memref<5x5xf32>, %arg2: memref<3x3xf32>) {
    ...
    ^bb0(%arg3: i32, %arg4: memref<7x7xf32>, %arg5: memref<5x5xf32>, %arg6: memref<3x3xf32>):  // no predecessors
      ...
      %11 = "equeue.alloc"(%10) {data_bit = 32 : i64, shape = dense<25> : tensor<1xi64>} : (i32) -> memref<25xf32>
      ...
      %14 = "equeue.alloc"(%13) {data_bit = 32 : i64, shape = dense<49> : tensor<1xi64>} : (i32) -> memref<49xf32>
            ...
            affine.for %arg10 = 0 to 3 {
              affine.for %arg11 = 0 to 5 step 5 {
                affine.for %arg12 = 0 to 5 {
                  %23 = "equeue.get_comp_field"(%arg3) {name = "wbuffer"} : (i32) -> memref<25xf32>
                  %24 = "equeue.get_comp_field"(%arg3) {name = "pe_array"} : (i32) -> vector<5xi32>
                  %25 = extract_element %24[%arg12] : vector<5xi32>
                  %26 = "equeue.get_comp_field"(%25) {name = "pe_wbuffer"} : (i32) -> memref<1xf32>
                  %27 = "equeue.get_comp_field"(%arg3) {name = "dma"} : (i32) -> i32
                  %28 = "equeue.control_start"() : () -> !equeue.signal
                  %29 = "equeue.memcpy"(%28, %23, %26, %27) {dest_bank = 0 : i64, src_bank = 0 : i64} : (!equeue.signal, memref<25xf32>, memref<1xf32>, i32) -> !equeue.signal
                    ...
                    affine.for %arg14 = #map8(%arg7) to #map9(%arg7) {
                      affine.for %arg15 = #map8(%arg8) to #map9(%arg8) {
                        affine.for %arg16 = #map8(%arg9) to #map9(%arg9) {
                          %30 = "equeue.get_comp_field"(%arg3) {name = "ibuffer"} : (i32) -> memref<49xf32>
                          %31 = "equeue.get_comp_field"(%arg3) {name = "pe_array"} : (i32) -> vector<5xi32>
                          %32 = extract_element %31[%arg16] : vector<5xi32>
                          %33 = "equeue.get_comp_field"(%32) {name = "pe_ibuffer"} : (i32) -> memref<1xf32>
                          %34 = "equeue.get_comp_field"(%arg3) {name = "dma"} : (i32) -> i32
                          %35 = "equeue.control_start"() : () -> !equeue.signal
                          %36 = "equeue.memcpy"(%35, %30, %33, %34) {dest_bank = 0 : i64, src_bank = 0 : i64} : (!equeue.signal, memref<49xf32>, memref<1xf32>, i32) -> !equeue.signal
                            ...
                            affine.for %arg18 = #map8(%arg11) to #map10(%arg11) {
                              affine.for %arg19 = #map8(%arg12) to #map9(%arg12) {
                                affine.for %arg20 = #map8(%arg13) to #map9(%arg13) {
                                  %37 = affine.load %18[%arg14, %arg16, %arg17, %arg20] : memref<1x3x3x1xf32, #map6>
                                  %38 = affine.load %16[%arg18, %arg19, %arg20, %arg15] : memref<5x5x1x1xf32>
                                  %39 = affine.load %17[%arg14, %arg16, %arg17, %arg15] : memref<1x3x3x1xf32>
                                  %40 = mulf %37, %38 : f32
                                  %41 = addf %39, %40 : f32
                                  affine.store %41, %17[%arg14, %arg16, %arg17, %arg15] : memref<1x3x3x1xf32>
                                }
                              }
                            }
                          }
