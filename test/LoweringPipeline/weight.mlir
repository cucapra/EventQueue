          ...
          affine.for %arg3 = 0 to 10 {
            ...
            affine.for %arg4 = 0 to 14 {
              ...
              affine.for %arg5 = 0 to 12 {
                ...
                %22 = "equeue.get_comp_field"(%21) {name = "pe_wbuffer"} : (i32) -> memref<1xf32>
                %23 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                %24 = affine.apply #map4(%arg4)
                %25 = extract_element %23[%arg5, %24] : vector<12x14xi32>
                %26 = "equeue.get_comp_field"(%25) {name = "pe_wbuffer"} : (i32) -> memref<1xf32>
                %27 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                %28 = extract_element %27[%arg5, %arg4] : vector<12x14xi32>
                %29 = "equeue.get_comp_field"(%28) {name = "proc"} : (i32) -> i32
                %30 = "equeue.control_start"() : () -> !equeue.signal
                %31 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                %32 = extract_element %31[%arg5, %arg4] : vector<12x14xi32>
                %33 = "equeue.get_comp_field"(%32) {name = "proc"} : (i32) -> i32
                %34 = "equeue.control_start"() : () -> !equeue.signal
                %done_2 = "equeue.launch"(%34, %33) ( {
                  %c0_3 = constant 0 : index
                  %35 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                  %36 = extract_element %35[%arg5, %arg4] : vector<12x14xi32>
                  %37 = "equeue.get_comp_field"(%36) {name = "pe_ibuffer"} : (i32) -> memref<1xf32>
                  %38 = "equeue.read"(%37) {bank = 0 : i64, size = dense<1> : tensor<1xi64>} : (memref<1xf32>) -> f32
                  %39 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                  %40 = extract_element %39[%arg5, %arg4] : vector<12x14xi32>
                  %41 = "equeue.get_comp_field"(%40) {name = "pe_wbuffer"} : (i32) -> memref<1xf32>
                  %42 = "equeue.read"(%41) {bank = 0 : i64, size = dense<1> : tensor<1xi64>} : (memref<1xf32>) -> f32
                  %43 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                  %44 = extract_element %43[%arg5, %arg4] : vector<12x14xi32>
                  %45 = "equeue.get_comp_field"(%44) {name = "pe_obuffer"} : (i32) -> memref<1xf32>
                  %46 = "equeue.read"(%45) {bank = 0 : i64, size = dense<1> : tensor<1xi64>} : (memref<1xf32>) -> f32
                  %47 = "equeue.unkOp"(%46, %38, %42) {op_name = "mac"} : (f32, f32, f32) -> f32
                  %48 = "equeue.get_comp_field"(%arg0) {name = "pe_array"} : (i32) -> vector<12x14xi32>
                  %49 = extract_element %48[%arg5, %arg4] : vector<12x14xi32>
                  %50 = "equeue.get_comp_field"(%49) {name = "pe_obuffer"} : (i32) -> memref<1xf32>
                  "equeue.write"(%47, %50) {bank = 0 : i64} : (f32, memref<1xf32>) -> ()
                  "equeue.write"(%42, %22) {bank = 0 : i64} : (f32, memref<1xf32>) -> ()
                  "equeue.return"() : () -> ()
