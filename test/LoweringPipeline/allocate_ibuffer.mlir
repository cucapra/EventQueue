...
module {
  func @graph(%arg0: memref<7x7xf32>, %arg1: memref<5x5xf32>, %arg2: memref<3x3xf32>) {
    ...
    ^bb0(%arg3: i32, %arg4: memref<7x7xf32>, %arg5: memref<5x5xf32>, %arg6: memref<3x3xf32>):  // no predecessors
      ...
      %14 = linalg.reshape %arg6 [#map2, #map3] : memref<3x3xf32> into memref<1x3x3x1xf32>
      %15 = subview %12[0, 0, 0, 0] [1, 3, 3, 1] [1, 1, 1, 1]  : memref<1x7x7x1xf32> to memref<1x3x3x1xf32, #map6>
                            ...
                            affine.for %arg18 = #map8(%arg11) to #map10(%arg11) {
                              affine.for %arg19 = #map8(%arg12) to #map9(%arg12) {
                                affine.for %arg20 = #map8(%arg13) to #map9(%arg13) {
                                  %18 = affine.load %15[%arg14, %arg16, %arg17, %arg20] : memref<1x3x3x1xf32, #map6>
                                  %19 = affine.load %13[%arg18, %arg19, %arg20, %arg15] : memref<5x5x1x1xf32>
                                  %20 = affine.load %14[%arg14, %arg16, %arg17, %arg15] : memref<1x3x3x1xf32>
                                  %21 = mulf %18, %19 : f32
                                  %22 = addf %20, %21 : f32
                                  affine.store %22, %14[%arg14, %arg16, %arg17, %arg15] : memref<1x3x3x1xf32>
                                }
                              }
                            }
                          }
      ...
      %16 = "equeue.get_comp_field"(%arg3) {name = "ibuffer"} : (i32) -> memref<49xf32>
      "equeue.dealloc"(%16) : (memref<49xf32>) -> ()
      %17 = "equeue.get_comp_field"(%arg3) {name = "pe_array"} : (i32) -> vector<5xi32>
      affine.for %arg7 = 0 to 5 {
        %18 = extract_element %17[%arg7] : vector<5xi32>
        %19 = "equeue.get_comp_field"(%18) {name = "pe_ibuffer"} : (i32) -> memref<1xf32>
        "equeue.dealloc"(%19) : (memref<1xf32>) -> ()
      }
      "equeue.return"() : () -> ()
